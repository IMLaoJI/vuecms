...
import userperfect from './components/users/userperfect.vue';
let router = new vueRouter({
	...
	routes:[
		...
		{name:'userinfo',path:'/userinfo',component:userinfo}, //个人信息页面的路由规则
		{name:'userperfect',path:'/userperfect',component:userperfect}, //个人信息完善页面的路由规则
		{name:'regist',path:'/regist',component:regist}, //个人注册页面
